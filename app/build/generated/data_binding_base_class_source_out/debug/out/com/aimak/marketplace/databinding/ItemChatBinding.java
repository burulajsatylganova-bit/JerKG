...
public final class ItemChatBinding implements ViewBinding {
  ...
  private ItemChatBinding(@NonNull LinearLayout rootView, @NonNull View dotUnread,
  ...
  public static ItemChatBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemChatBinding((LinearLayout) rootView, dotUnread, tvAvatar, tvLastMessage,
          tvName, tvTime);
    }
