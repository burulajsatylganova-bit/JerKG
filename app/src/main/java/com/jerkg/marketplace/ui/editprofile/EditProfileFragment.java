package com.jerkg.marketplace.ui.editprofile;
...
import com.jerkg.marketplace.databinding.FragmentEditProfileBinding;
...
public class EditProfileFragment extends Fragment {
    ...
    private void setupSaveButton() {
        ...
        binding.btnChangePhoto.setOnClickListener(v ->
                Toast.makeText(getContext(), "Загрузка фото — скоро", Toast.LENGTH_SHORT).show());
    }
                ...
                .addOnFailureListener(e -> {
                    ...
                    db.collection("users").document(currentUid)
                            ...
                            .addOnFailureListener(e2 ->
                                    Toast.makeText(getContext(), "Ошибка: " + e2.getMessage(),
