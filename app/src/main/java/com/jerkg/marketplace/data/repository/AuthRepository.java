// Файл: app/src/main/java/com/jerkg/marketplace/data/repository/AuthRepository.java
...
import com.jerkg.marketplace.data.model.User;
...
public class AuthRepository {
    ...
    public void verifyCode(
        ...
        if (verificationId == null) {
            onError.onError("Сначала запросите код");
            return;
        }
    ...
    private void signInWithCredential(
        ...
        auth.signInWithCredential(credential)
                ...
                .addOnFailureListener(e -> {
                    if (onError != null) {
                        onError.onError("Неверный код. Попробуйте снова.");
                    }
                });
    }
