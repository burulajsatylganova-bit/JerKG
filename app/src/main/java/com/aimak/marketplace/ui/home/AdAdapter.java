...
import com.aimak.marketplace.utils.ImageUtils;
    ...
    class AdViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(Ad ad) {
            ...
            if (ad.isNegotiablePrice()) {
                tvPrice.setText(itemView.getContext().getString(R.string.price_negotiable_short));
            } else {
                tvPrice.setText(ad.getFormattedPrice() + itemView.getContext().getString(R.string.currency_som));
            }
