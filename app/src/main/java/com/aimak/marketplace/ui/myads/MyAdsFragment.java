package com.aimak.marketplace.ui.myads;
...
import com.aimak.marketplace.databinding.FragmentMyAdsBinding;
        ...
        adRepo.getMyAds(new AdRepository.AdsCallback() {
            ...
            public void onSuccess(List<Ad> ads) {
                ...
                if (ads.isEmpty()) {
                    ...
                    binding.tvCount.setText(getString(R.string.total_ads) + ads.size());
                    adapter.setAds(ads);
                }
            }
