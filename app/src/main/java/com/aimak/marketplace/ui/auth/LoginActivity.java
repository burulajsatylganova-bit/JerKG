...
import com.aimak.marketplace.databinding.ActivityLoginBinding;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void setupUI() {
        ...
        binding.btnSendCode.setOnClickListener(v -> {
            ...
            // Валидация
            if (phone.isEmpty()) {
                binding.etPhone.setError(getString(R.string.error_enter_phone));
                return;
            }
    ...
    private void showStep2() {
        ...
        binding.tvPhoneHint.setText(getString(R.string.code_sent_to) + phone);
